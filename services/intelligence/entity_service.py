...
def get_entity_summary():
    ...
    # Robust parameter resolution: accept symbol, ticker, or entity_name
    symbol = request.args.get('symbol') or request.args.get('ticker') or request.args.get('entity_name') or ''
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="ASETPEDIA ENTITY SERVICE")
    ...
    threading.Thread(target=ticker_background_thread, daemon=True).start()

    print(f"ENTITY_SERVICE: Starting on port {args.port}...")
