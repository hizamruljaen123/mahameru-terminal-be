...
TOOL_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "symbol": {"type": "string", "description": "Ticker symbol e.g. BBRI.JK"},
                    "include": {"type": "string", "enum": ["all", "summary", "rsi", "macd", "bb", "sma", "ema", "stochastic", "adx", "atr", "volume", "sar"], "default": "summary", "description": "Indicators to include (use 'summary' for core signals/levels or 'all' for full data)"},
    ...
    # -----------------------------------------------------------------------
    {
        ...
        "function": {
            ...
            "description": "MANDATORY for visual maritime surveillance. Displays a real-time interactive radar/map view for a specific location, strait, or port (e.g. Singapore, Malacca, Rotterdam). Use this when user wants to 'see' or 'check' a region.",
            "parameters": {
                "type": "object",
                "properties": {
                    "location": {"type": "string", "description": "Location name, port, or strait to view radar for."}
                },
                "required": ["location"]
            }
        }
    ...
    },
    {
        ...
        "function": {
            "name": "execute_code",
            "description": "Execute code in a SECURE, ISOLATED sandbox. The environment has NO access to server environment variables, API keys, or root/admin privileges. Supports Python (Isolated Mode), JavaScript, and Shell. Use this for calculations or data processing safely.",
            "parameters": {
                "type": "object",
                "properties": {
                    "language": {"type": "string", "enum": ["python", "javascript", "bash", "shell", "cmd"], "description": "The programming language of the code."},
