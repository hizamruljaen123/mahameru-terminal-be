...
OSIRIS_API_KEY = os.getenv("OSIRIS_API_KEY", "")
OSIRIS_API_URL = os.getenv("OSIRIS_BASE_URL", "https://ai.osiris-code.com/v1")
...
if LLM_PROVIDER == "dit":
    ...
    LLM_API_KEY = os.getenv("COPILOT_LLM_API_KEY") or os.getenv("OPENROUTER_API_KEY", "")
    LLM_BASE_URL = os.getenv("COPILOT_LLM_BASE_URL") or "https://openrouter.ai/api/v1"
    LLM_MODEL = os.getenv("COPILOT_LLM_MODEL", "openai/gpt-oss-120b")
else:
...
if not SSL_VERIFY:
    print("[WARNING] SSL verification is DISABLED. This should only be used in local development.")
